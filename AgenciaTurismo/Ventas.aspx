            ...
            <form id="form1" runat="server">
                ...
                <div class="form-planes">
                     <div class="form-group">
                         ...
                         <asp:TextBox ID="txtCodigoPlan" runat="server" CssClass="textbox"></asp:TextBox><br />
                         ...
                         <div class="buttons">                             
                             <asp:Button ID="btnCalcular" runat="server" Text="Calcular" OnClick="btnCalcular_Click" CssClass="buttons" />
                         </div>
                         <div class="resultado">
